...
def test_fulfill_quality(
    prv_contributions: Dict[Any,float],
    start_balances: Dict[Any,float],
    update_balances: Any = None
    ):
    ...
    for id,loan_amount in loan_requests.items():
        ...
        contrib, new_balance_opt = fulfill(loan_amount,
                                           start_balances)
        ...
        dist = sp.spatial.distance.cosine(list(new_balance_opt.values()),
                                          list(new_balance_act.values()))
...
def test_edge_case():
    ...
    contrib, new_balances = fulfill(100000,
            {1:50000,2:25000,3:10000,4:10000,5:20000,6:5000,7:5000})
...
day1_contrib = {'Rohit':{53602:5000,53611:12000,53609:10000,53610:10000},
                'Sanjay':{53602:1000},
                'Renu':{53602:1000},
...
day2_contrib = {'Rohit':{1:20000,2:14000,3:12000,4:5000},
